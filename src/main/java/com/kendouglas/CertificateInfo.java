...
public class CertificateInfo {
    ...
    private static Logger log = Logger.getLogger("CertificateInfo");
    ...
    public CertificateInfo(X509Certificate certificate) {
        ...
        try {
            subjectdnfieldextractor = new X509Principal(certificate. getSubjectX500Principal().getName());
            issuerdnfieldextractor = new X509Principal(certificate. getIssuerX500Principal().getName());
        }
       catch (Exception e)
       {
        ...
        if (altNames != null) {
            ...
            while (i.hasNext()) {
                ...
                if (seq != null) {
                    ...
                    DERObjectIdentifier id = DERObjectIdentifier
    ...
    private static ASN1Sequence getAltnameSequence(byte[] value)
        ...
        DERObject oct = null;
        try {
            oct = (new ASN1InputStream(new ByteArrayInputStream(value))
                    .readObject());
